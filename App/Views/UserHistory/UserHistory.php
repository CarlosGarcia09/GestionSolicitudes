...
<body>
  ...
  <div class="text-center container">
    <form class="form-horizontal" method="POST" action="<?= FOLDER_PATH.'/UserHistory/creaHistoria' ?>">
      <h1 class="h3 mb-3 ">Crear historia de usuario</h1>
      ...
      <div class="form-group row">
        <div class="col-sm-3"></div>
        <label class="col-sm-2 ">Historia*</label>
        <div class="col-sm-4">
          <textarea class="form-control" name="historia" rows="5"></textarea>
        </div>
      </div>
